...
(function () {
     ...
     * "相对于网站根目录的相对路径"也就是以斜杠开头的形如"/myProject/ueditor.js/"这样的路径。
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
			...
			'customstyle', 'paragraph', 'fontfamily', 'fontsize', '|','touppercase', 'tolowercase', '|',
            'link', 'unlink', 'anchor'],
			['simpleupload', 'insertimage', 'emotion', 'insertvideo', 'attachment', 'insertcode','background', '|' ,
        ...
        ,initialFrameWidth:'66%'  //初始化编辑器宽度,默认1000
